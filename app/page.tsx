...
export default function Home() {
  ...
  return (
    <div>
      <header
        className="flex flex-col h-screen text-white justify-center items-center w-full"
        style={{
      ...
      >
        ...
        <div className=" flex flex-col justify-between items-center h-1/2 w-full p-2.5 lg:h-1/4 lg:w-1/2 text-center flex-wrap">
          ...
          <p className="text-lg lg:text-xl">{PageData.header.description}</p>
      ...
      <div className="min-h-screen flex flex-col w-full items-center space-y-10 p-4">
        ...
        <div className="flex flex-col lg:flex-row justify-center lg:w-[70%]">
          ...
          <div className="flex flex-col p-2.5 justify-between">
            ...
            <p className="text-base lg:text-lg">
              {data.main.ourCommitment.description}
            </p>
        ...
        <div className="flex flex-col lg:w-[70%] space-y-5">
          <h1 className="text-3xl font-bold">
            {data.main.latestInsights.title}
          </h1>
